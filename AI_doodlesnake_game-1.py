...
def main():
	...
	screen = pygame.dissplay.set_mode((SCREEN_WIDTH, SCREEN_HEIGHT))
...
def game_over():
	...
	gameauthor_line1 = game_font.render('dsc出品 ', True, (20, 20, 255))
	...
	gameauthor_line2 = game_font.render('welcome to my game - DDoodlesnake', True, (20, 20, 255))
