...
#TODO
def game_start(screen,game_font,game_clock):
	...
	while True:
		...
		angle -= 5
#TODO
def game_over(screen,game_font):
	title_Font = pygame.font.SysFont('SimHei', 120) 
	...
	gameauthor_line1 = game_font.render('FROM dsc ', True, (20, 20, 255))
	...
	gameauthor_line2 = game_font.render('CQU-Ex', True, (20, 20, 255))
...
def anypossible_move(psnake, pboard, pfood):
	...
	return best_move
#TODO
def game_play(screen,game_starttime,game_font,game_clock):
	board = [0] * FIELD_SIZE
	...
	while True:
		...
		init_snake(screen,snake_Coords)
		create_food(screen,food_location)
...
def main():
        ...
        game_start(screen,game_font,game_clock)
        while True:
                game_play(screen,game_starttime,game_font,game_clock)
                game_over(screen,game_font)
